...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='data2text',
                        choices=(
                            'data2text', 'triples', 'webnlg', 'writingPrompts', 'cnndm', 'xsum', 'sentiment', 'topic',
    ...
    parser.add_argument('--optim_prefix', type=str, default='yes', choices=('yes', 'no'))
    parser.add_argument('--preseqlen', type=int, default=10, help='')
    parser.add_argument('--prefix_mode', type=str, default='activation', choices=('embedding', 'activation'))
    parser.add_argument('--format_mode', type=str, default='cat', choices=('cat', 'infix', 'peek', 'nopeek'))
...
#
# nlprun -a lisa-base-torch -g 1 --p high -n 5top-finetune -x jagupard4,jagupard5,jagupard6,jagupard7,jagupard8,
# jagupard10,jagupard11,jagupard12,jagupard13,jagupard14,jagupard15,jagupard16,jagupard17,jagupard18,jagupard19,
# jagupard20,jagupard21,jagupard22,jagupard23,jagupard24,jagupard25 '$COMMANDLINE'
...
#                    '--replay_buffer {} ' \
#                    '--training_obj {} ' \
#                    '--dataless_discri_model_path {}'.format(8, 60, 'yes', 2, 'no', 'yes', 0,
#                    'textattack/roberta-base-imdb') # 2 for sentiment;; 3 for length.
#                    # '--dataless_discri_model_path {}'.format(4, 60, 'yes', 2, 'no', 'yes', 0,
#                    'textattack/roberta-base-ag-news')  # 2 for sentiment;; 3 for length.
