...
# All rights reserved. This source code is licensed under the BSD-style license found in the LICENSE file in the root
...
def get_data_loaders(args, tokenizer):
    ...
    for dataset_name, dataset in tqdm.tqdm(personachat.items()):
...
def train():
    ...
    tokenizer_class = GPT2Tokenizer if "gpt2" in args.model_checkpoint else OpenAIGPTTokenizer  # cant use
    # Autotokenizer because checkpoint could be a Path
    ...
    def update(engine, batch):
        ...
        # mc_token_ids: (batch_size, 2)
        # lm_labels: (batch_size, 2, seq_len)
        # mc_labels: (batch_size,)
        # token_type_ids: (batch_size, 2, seq_len)
