...
run:
    python -m gpt2.launchers.gather_063021 --mode "submit"
    python -m gpt2.launchers.gather_063021 --mode "local"
"""
...
def main(
    ...
    if mode == wrapper.Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2', 'scripts', f'gather_063021.sh')
