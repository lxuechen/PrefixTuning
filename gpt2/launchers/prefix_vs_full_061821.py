...
run:
    to generate running scripts:
        python -m gpt2.launchers.prefix_vs_full_061821 --mode "submit"
    to run local:
        python -m gpt2.launchers.prefix_vs_full_061821 --mode "local"
"""
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        for seed in seeds:
            ...
            for train_batch_size in (100, 200, 5, 25, 500, 1000):
        ...
        script_path = os.path.join('.', 'gpt2', 'scripts', f'prefix_vs_full_061821.sh')
