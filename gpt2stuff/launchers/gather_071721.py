...
run:
    python -m gpt2stuff.launchers.gather_071721 --mode "submit"
    python -m gpt2stuff.launchers.gather_071721 --mode "local"
"""
...
def main(
    ...
    if mode == wrapper.Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'gather_071721.sh')
