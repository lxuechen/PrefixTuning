...
date:
    071121
purpose:
    Run private from scratch baseline experiments.
notes:
    gpt2-medium memory failure.
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_071121 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_071121 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        for seed in seeds:
            for model_name_or_path in ("gpt2-medium",):
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'prefix_vs_full_071121.sh')
