...
run:
    python -m gpt2stuff.launchers.gather_071621 --mode "submit"
    python -m gpt2stuff.launchers.gather_071621 --mode "local"
"""
...
def main(
    ...
    if mode == wrapper.Mode.local:
                            ...
                            for target_epsilon in (3,):
                                for epochs in (50,):
                                    for tuning_mode in ("prefixtune",):
                                        ...
                                        # @formatter:off
                                        train_dir = (
                                            f"/nlp/scr/lxuechen/prefixtune/date_0716"
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'gather_071621.sh')
