...
date:
    0726
purpose:
    Sanitize DART generation files. Some prompts don't have references! Fuck!
notes:
    These are CPU-only jobs. So submit to john.
run:
    python -m gpt2stuff.launchers.sanitize_dart_072621 --mode "submit"
    python -m gpt2stuff.launchers.sanitize_dart_072621 --mode "local"
"""
