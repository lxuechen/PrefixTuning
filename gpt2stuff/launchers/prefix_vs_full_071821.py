...
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_071821 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_071821 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        for seed in seeds:
            for max_grad_norm in (0.1,):
                for model_name_or_path in ("distilgpt2",):
                    for i, train_batch_size in enumerate((512,)):
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'prefix_vs_full_071821.sh')
