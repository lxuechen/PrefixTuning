...
date:
    072021
purpose:
    Run everything on dart.
notes:
    prefixtune, fulltune, scratchtune, lineartune
    private 2 3 5 8
    non-private
    gpt2
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_072021 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_072021 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        # TODO: This is different from E2E.
        max_seq_len = 120  # You don't lose too much.
        max_grad_norm = 0.1
        nonprivate = "no"
        task_mode = "triples"
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'prefix_vs_full_072021.sh')
