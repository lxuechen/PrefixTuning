...
purpose:
    ...
    Full-tune.
notes:
    Patches 070221_v2 by running for fewer epochs.
    Naming of this file is for consistency.
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_070221_v3 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_070221_v3 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'prefix_vs_full_070221_v3.sh')
