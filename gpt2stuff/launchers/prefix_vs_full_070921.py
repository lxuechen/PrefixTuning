...
notes:
    scratchtune for distilgpt2, gpt2, gpt2-medium
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_070921 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_070921 --mode "local"
"""
