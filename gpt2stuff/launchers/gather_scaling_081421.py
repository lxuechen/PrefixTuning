# python -m gpt2stuff.launchers.gather_scaling_081421; sc
import os
import uuid
...
def main(
    ...
    for base_dir in (
        "/nlp/scr/lxuechen/prefixtune/date_080921",
    ):
    ...
    script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'gather_scaling_081421.sh')
