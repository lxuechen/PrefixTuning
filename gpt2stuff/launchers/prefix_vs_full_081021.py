...
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_081021 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_081021 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'prefix_vs_full_081021.sh')
