...
notes:
    ...
    Rerun all the fulltune and scratch tune experiments, since I was stupid.
    Also epsilon=8 results in /date_062721
run:
    to generate running scripts:
        python -m gpt2.launchers.prefix_vs_full_062621_v3 --mode "submit"
    to run local:
        python -m gpt2.launchers.prefix_vs_full_062621_v3 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2', 'scripts', f'prefix_vs_full_062621_v3.sh')
