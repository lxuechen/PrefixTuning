...
run:
    to generate running scripts:
        python -m gpt2.launchers.prefix_vs_full_062921 --mode "submit"
    to run local:
        python -m gpt2.launchers.prefix_vs_full_062921 --mode "local"
"""
...
def main(
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2', 'scripts', f'prefix_vs_full_062921.sh')
