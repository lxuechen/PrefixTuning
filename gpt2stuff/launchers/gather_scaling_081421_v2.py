# python -m gpt2stuff.launchers.gather_scaling_081421_v2; sc1
import os
import uuid
...
def main(
    ...
    script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'gather_scaling_081421_v2.sh')
