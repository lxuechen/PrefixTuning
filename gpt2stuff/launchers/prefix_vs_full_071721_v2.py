...
run:
    to generate running scripts:
        python -m gpt2stuff.launchers.prefix_vs_full_071721_v2 --mode "submit"
    to run local:
        python -m gpt2stuff.launchers.prefix_vs_full_071721_v2 --mode "local"
"""
...
def main(
    seeds=(1,),  # Seeds over which to randomize.
    mode=Mode.local,
    ...
    **kwargs,
    ...
    if mode == Mode.local:
        ...
        script_path = os.path.join('.', 'gpt2stuff', 'scripts', f'prefix_vs_full_071721_v2.sh')
